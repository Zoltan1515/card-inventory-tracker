...
assert(page.includes('value={String(sellingUnitPrice)}'), 'Sale modal card sale field should show the per-item sale amount and store the multiplied total.');
assert(page.includes('value={String(sellingShippingUnitPrice)}'), 'Sale modal shipping field should show buyer shipping per item and store the multiplied total collected.');
